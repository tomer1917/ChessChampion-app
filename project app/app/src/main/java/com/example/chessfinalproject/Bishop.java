...
public class Bishop extends Soldier {
    ...
    public Bishop(Bitmap imageBitmap, boolean whitePiece, int[] startingPosition, int[][] validMovement, boolean infiniteMovement,int[][] validAttack,boolean canRunOver,boolean canAttackOver, boolean infiniteAttack) {
