...
public class Knight extends Soldier {
    ...
    public Knight(Bitmap imageBitmap, boolean whitePiece, int[] startingPosition, int[][] validMovement, boolean infiniteMovement,int[][] validAttack,boolean canRunOver,boolean canAttackOver, boolean infiniteAttack) {
