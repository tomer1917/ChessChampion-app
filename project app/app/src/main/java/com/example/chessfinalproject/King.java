...
public class King extends Soldier {
    ...
    boolean moved = false;
    public King(Bitmap imageBitmap, boolean whitePiece, int[] startingPosition, int[][] validMovement, boolean infiniteMovement,int[][] validAttack,boolean canRunOver,boolean canAttackOver, boolean infiniteAttack) {
        ...
        for (int i = 0; i < validMovement.length; i++) {
            ...
            if (infiniteMovement) {
                ...
                while (row<rows && col< cols&& row>=0 && col>=0 ) {
                    ...
                    //if the current tile is in this current movement
                        ...
                        if (Soldier.customChess){
                            ...
                            if (canRunOver || !runOver) moved = true;
                ...
                if (Soldier.customChess) {
                    ...
                    if (castling(currentTile, boardTileMatrix)) return true;
                ...
                while (row<rows && col< cols&& row>=0 && col>=0 ) {
                    ...
                    //if the current tile is in this current movement
                        ...
                        if (currentTile.currentSoldier.whitePiece != whitePiece)
                        {
                            ...
                            {
                                if ((canAttackOver || !runOver)) moved = true;
    ...
    //check for castling
    public boolean castling(BoardTile currentTile,BoardTile[][] boardTileMatrix){
        if (rows != 8 && cols !=8)return false;

        if (whitePiece){
            if (currentTile == boardTileMatrix[7][2]){
                if (boardTileMatrix[7][0].currentSoldier instanceof Rook && !((Rook) boardTileMatrix[7][0].currentSoldier).moved && !moved
                        && boardTileMatrix[7][1].currentSoldier == null && boardTileMatrix[7][2].currentSoldier == null && boardTileMatrix[7][3].currentSoldier == null){

                    return true;
                }
            }
            if (currentTile == boardTileMatrix[7][6]){
                if (boardTileMatrix[7][7].currentSoldier instanceof Rook && !((Rook) boardTileMatrix[7][7].currentSoldier).moved && !moved
                        && boardTileMatrix[7][6].currentSoldier == null && boardTileMatrix[7][5].currentSoldier == null){
            ...
            if (currentTile == boardTileMatrix[0][2]){
                if (boardTileMatrix[0][0].currentSoldier instanceof Rook && !((Rook) boardTileMatrix[0][0].currentSoldier).moved && !moved
                        && boardTileMatrix[0][1].currentSoldier == null && boardTileMatrix[0][2].currentSoldier == null && boardTileMatrix[0][3].currentSoldier == null){

                    return true;
                }
            }
            if (currentTile == boardTileMatrix[0][6]){
                if (boardTileMatrix[0][7].currentSoldier instanceof Rook && !((Rook) boardTileMatrix[0][7].currentSoldier).moved && !moved
                        && boardTileMatrix[0][6].currentSoldier == null && boardTileMatrix[0][5].currentSoldier == null){
