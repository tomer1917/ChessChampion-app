...
public class Rook extends Soldier {
    ...
    boolean moved = false;
    public Rook(Bitmap imageBitmap, boolean whitePiece, int[] startingPosition, int[][] validMovement, boolean infiniteMovement,int[][] validAttack,boolean canRunOver,boolean canAttackOver, boolean infiniteAttack) {
